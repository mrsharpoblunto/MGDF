...
SUITE(ResourcesTests) {
  ...
  TEST_FIXTURE(ResourcesTestFixture, PathTests) {
    ...
    CHECK_WS_EQUAL(root + L"game/bin/module.dll",
                   Resources::Instance().Module());

    CHECK_WS_EQUAL(root + L"game/game.json", Resources::Instance().GameFile());
    CHECK_WS_EQUAL(root + L"game/preferences.json",
    ...
    CHECK_WS_EQUAL(root + L"resources/preferences.json",
    ...
    CHECK_WS_EQUAL(L"c:/MGDF/preferences.json",
                   Resources::Instance().GameDefaultPreferencesFile());
    ...
    CHECK_WS_EQUAL(root + L"user/junkship/",
                   Resources::Instance().UserBaseDir());
    CHECK_WS_EQUAL(root + L"user/junkship/working/",
                   Resources::Instance().WorkingDir());
    CHECK_WS_EQUAL(root + L"user/junkship/preferences.json",
                   Resources::Instance().GameUserPreferencesFile());
    CHECK_WS_EQUAL(root + L"user/junkship/saves/",
                   Resources::Instance().SaveBaseDir());
    CHECK_WS_EQUAL(root + L"user/junkship/saves/save1/gameState.json",
                   Resources::Instance().GameStateSaveFile("save1"));
    CHECK_WS_EQUAL(root + L"user/junkship/saves/save1/",
                   Resources::Instance().SaveDir("save1"));
    CHECK_WS_EQUAL(root + L"user/junkship/saves/save1/data/",
