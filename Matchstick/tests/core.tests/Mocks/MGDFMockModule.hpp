...
public:
	...
	virtual bool NewModule(const wchar_t *workingFolder) { return true; }
	virtual bool LoadModule(const wchar_t *workingFolder,const wchar_t *saveDataFolder) { return true; }
	...
	virtual bool SaveModule(const wchar_t *saveDataFolder){ return true; }
	virtual void Panic(){}
