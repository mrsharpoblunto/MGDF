...
DataLoader.exe is a graphical tool which allows you as a developer to log into an online gamesource and add/edit/remove your games. Using packages generated by packageGen.exe you can then upload these to a gamesource repository using this tool.
...
${FeedName} - the name of the gameSource's RSS feed
${FeedDescription} description of the gameSources RSS feed.
${FeedLink} - Url to an html page that this feed links to
${Host} - the hostname the service will be hosted at.
${AuthenticationRealm} - the authentication realm of the gameSource (used as part of http digest authentication)
${Name} - the name of the gameSource
${Description} - a description of the gamesource
