...
namespace MGDF.GamesManager.Model.Entities.XmlEntities
{
    public class XmlValidator
    {
        ...
        private XmlReaderSettings GetSchemaSettings(string xmlSchema)
        {
            ...
            if (xsdStream == null) FileSystem.Current.GetFile(FileSystem.Combine(EnvironmentSettings.Current.AppDirectory, Constants.SchemaDir, xmlSchema)).OpenStream(FileMode.Open);
