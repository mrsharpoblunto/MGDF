...
{
    internal class Game: XmlEntity, IGame, IEquatable<Game>
    {
        ...
        {
            if (FileSystem.Current.FileExists(Constants.GameIconFile(Uid)))
            {
                var file = FileSystem.Current.GetFile(Constants.GameIconFile(Uid));
        ...
        {
            if (GameFile.Parent.Children.ContainsKey(Constants.GameIcon))
            {
                try
                {
                    IArchiveFile file = GameFile.Parent.Children[Constants.GameIcon];
        ...
        public IPendingOperation PendingOperation
        {
        ...
        public void Save(string filename)
        {
            ...
            {
                var iconFile = FileSystem.Current.GetFile(Path.Combine(file.Parent.FullName,Constants.GameIcon));
