...
CREATE TABLE "mgdf_gamefragments" (
  "Id" uniqueidentifier NOT NULL PRIMARY KEY,
...
CREATE TABLE "mgdf_gameversions" (
  "Id" uniqueidentifier NOT NULL PRIMARY KEY,
...
CREATE TABLE "mgdf_defaultfileservergamedata" (
  "Id" uniqueidentifier NOT NULL PRIMARY KEY,
  "GameFile" VarChar(255) NOT NULL
);

CREATE TABLE "mgdf_amazons3fileservergamedata" (
  "Id" uniqueidentifier NOT NULL PRIMARY KEY,
...
CREATE TABLE "mgdf_amazons3uploadpart" (
  "Id" uniqueidentifier NOT NULL PRIMARY KEY,
...
CREATE TABLE "mgdf_cnonce" (
  "Id" uniqueidentifier NOT NULL PRIMARY KEY,
  "Expires" datetime NOT NULL
);

CREATE TABLE "mgdf_queuedfiledelete" (
  "Id" uniqueidentifier NOT NULL PRIMARY KEY,
...
ALTER TABLE "mgdf_amazons3uploadpart"
...
ALTER TABLE mgdf_gamefragments
