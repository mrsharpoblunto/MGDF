...
class IStatisticsManager {
 public:
  /**
   ...
   \return MGDF_OK if the statistic could be saved, MGDF_ERR_INVALID_STATS_KEY
   if the statistic key was invalid due to containing a space character or being
