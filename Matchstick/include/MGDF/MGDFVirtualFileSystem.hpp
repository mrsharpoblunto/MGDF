...
public:
	...
	*/
	...
	/**
	 ...
	 \param filter a user supplied filter to filter the results
	...
	*/
	...
	\returns the name of the archive file the entity belongs to, otherwise it returns nullptr
	*/
	...
	*/
	...
	/**
	get the path to the file as expressed as a vfs logical file path (i.e. paths are relative to the vfs root)
...
public:
	...
	*/
	...
	/**
	tells the archive handler to dispose of itself. The object cannot be used after this is called
	*/
