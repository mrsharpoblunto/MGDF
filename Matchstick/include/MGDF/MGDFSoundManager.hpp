...
public:
	...
	*/
	...
	/**
	create a sound from a file in the VFS returns nullptr if the sound could not be created (see ->GetLastError() to get details as to why it failed)
	...
	*/
	...
	also returns nullptr if the stream could not be created (see ->GetLastError() to get details as to why it failed)
	\param file the data source for the sound
	*/
