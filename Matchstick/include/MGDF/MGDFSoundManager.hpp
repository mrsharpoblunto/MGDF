...
class ISoundManager {
  ...
  */
  ...
  /**
   ...
   player) \return the vector representing the forward direction of the listener
   (i.e. the player)
   */
  ...
  /**
   ...
   player) \return the vector representing the upward direction of the listener
   (i.e. the player)
   */
  ...
  */
  virtual MGDFError CreateSound(IFile *file, INT32 priority,
                                ISound **sound) = 0;
